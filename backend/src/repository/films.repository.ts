...
export class FilmRepository {
  ...
  async update(id: string, filmData: Partial<Film>): Promise<FilmDocument | null> {
  ...
  async addScheduleItem(filmId: string, scheduleItem: any): Promise<FilmDocument | null> {
  ...
  async updateScheduleItem(filmId: string, scheduleItemId: string, updateData: any): Promise<FilmDocument | null> {
  ...
  async addTakenSeats(filmId: string, scheduleId: string, seatKeys: string[]): Promise<FilmDocument | null> {
    return this.filmModel.findByIdAndUpdate(
        filmId,
        {
            $addToSet: {
  ...
  async removeTakenSeats(filmId: string, scheduleId: string, seatKeys: string[]): Promise<FilmDocument | null> {
    return this.filmModel.findByIdAndUpdate(
        filmId,
        {
            $pull: {
